      ...
      .then((res) => {
        ...
        donationActivities = res.data
          ...
          .map((d: any) => ({
            ...
            message:
              language === "ur"
                ? `نئی عطیہ: ${d.quantity}${d.quantityUnit || ""} ${
                    d.foodType || ""
                  } (${d.location || "نامعلوم"})`
                : `New donation: ${d.quantity}${d.quantityUnit || ""} ${
                    d.foodType || ""
                  } in ${d.location || "Unknown"}`,
            date: d.createdAt,
          }));
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="text-lg px-8 py-6">
              <Link to="/donate">
                {language === "ur" ? "عطیہ دیں" : t("btn.donate")}
              </Link>
            </Button>
            <Button
              asChild
            ...
            >
              <Link to="/request">
                {language === "ur" ? "درخواست دیں" : t("btn.request")}
              </Link>
            </Button>
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              {sortedFeed.map((activity, idx) => (
                ...
                >
                  ...
                  <p
                    className={`text-sm ${
                      language === "ur" ? "font-urdu text-right w-full" : ""
                    }`}
                  >
                    {activity.message} -{" "}
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <Button asChild variant="secondary" className="w-full">
                  <Link to="/ngo">
                    {language === "ur" ? "لاگ ان" : t("btn.login")}
                  </Link>
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild variant="secondary" size="lg">
              <Link to="/map">
                {language === "ur" ? "نقشہ دیکھیں" : t("btn.viewMap")}
              </Link>
            </Button>
            <Button
              asChild
            ...
            >
              <Link to="/transparency">
                {language === "ur" ? "شفافیت دیکھیں" : t("btn.learnMore")}
              </Link>
            </Button>
          </div>
        </div>
